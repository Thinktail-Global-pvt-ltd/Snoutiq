...
//         </div>
//         {messages.length > 0 && (
//           <button onClick={clearChat} className="text-sm bg-gray-100 hover:bg-gray-200 px-3 py-1 rounded-md transition-colors" disabled={sending}>
//             Clear Chat
//           </button>
//         )}
//       </div>
...
//             </div>
//           ) : messages.length === 0 ? (
//             <div className="text-center text-gray-600 py-8">No messages</div>
//           ) : (
//             <div className="space-y-4">
//               {messages.map((msg, index) => <MessageBubble key={msg.id || index} msg={msg} />)}
//               <div ref={messagesEndRef} />
//             </div>
//           )}
//         </div>
