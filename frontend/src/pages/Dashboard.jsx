...
const Dashboard = () => {
    ...
    const fetchChatHistory = useCallback(async (specificChatRoomToken = null) => {
        ...
        try {
            setIsLoading(true);
            let url = "https://snoutiq.com/index.php/api/chat/history";

            // If specific chat room token is provided, fetch that chat's history
            if (specificChatRoomToken) {
                url = `https://snoutiq.com/index.php/api/chat/room/${specificChatRoomToken}/history`;
            }
    ...
    const handleSendMessage = useCallback(async (inputMessage) => {
        ...
        try {
            ...
            const res = await axios.post(
                "https://snoutiq.com/index.php/api/chat/send",
                payload,
                {
                    headers: { Authorization: `Bearer ${token}` },
                    timeout: 30000
