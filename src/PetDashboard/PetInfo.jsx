      ...
      <div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center mb-8">
            ...
            <button
              onClick={() => navigate("/user-dashboard/add-pet")}
            ...
            <div className="bg-white rounded-2xl shadow-sm p-6 mb-8 grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600">
                  {
                    pets.filter(
                      (pet) => pet.documents && pet.documents.length > 0
                    ).length
                  }
                </div>
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-blue-600">
                  {pets.reduce(
                    (total, pet) =>
                      total + (pet.documents ? pet.documents.length : 0),
                    0
                  )}
                </div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 text-center">
                            ...
                            >
                              <FaUpload className="mr-2" /> Select files to
                              upload
                            </label>
                          ...
                          {uploadedDocs.length > 0 && (
                            <div className="mt-2">
                              ...
                              {uploadedDocs.map((file, index) => (
                                <div
                                  key={index}
                                  className="flex items-center justify-between text-sm bg-gray-100 p-2 rounded mt-1"
                                >
                                  <span>{file.name}</span>
                                  <button
                                    type="button"
