...
export default function KittenVaccinationDelhi() {
  const title = "Kitten Vaccination Package Delhi NCR — Starting ₹2,499 | SnoutiQ";
  const description =
    "Complete kitten vaccination package in Delhi NCR. Tricat, Rabies, Deworming included. Experienced vets at 50+ verified clinics. Book online. Starting ₹2,499.";
  const keywords =
    "kitten vaccination Delhi, kitten vaccine package Delhi NCR, kitten shots Delhi, kitten vaccination cost Delhi";
  const canonical = "https://snoutiq.com/services/kitten-vaccination-delhi";
        ...
        <section className="bg-gradient-to-br from-brand-light via-white to-white py-16 md:py-24 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
              Complete Kitten Vaccination Package in Delhi NCR
            </h1>
            <p className="text-lg md:text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
              All vaccines. All visits. One package. Administered by experienced vets at trusted
              clinics across Delhi, Gurugram, Noida, and Faridabad.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              <div className="text-center sm:text-right">
                <p className="text-sm text-slate-500">Starting from</p>
                <p className="text-3xl font-bold text-brand">₹2,499</p>
              </div>

              <div className="hidden sm:block w-px h-12 bg-slate-200" />

              <Link to="/lp/kitten-vaccination" className="w-full sm:w-auto">
