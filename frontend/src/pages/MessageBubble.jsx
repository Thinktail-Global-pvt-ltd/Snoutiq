            ...
            <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-xl shadow-sm">
                <div className="flex items-start mb-3">
                    ...
                    <div className="flex-1">
                        <h3 className="font-semibold text-red-800 text-sm">Emergency Care Required</h3>
                        <p className="text-red-700 text-sm mt-1">Your pet needs immediate veterinary attention</p>
                    </div>
                </div>
                <button
                    onClick={() => window.location.href = "/book-clinic-visit"}
                    className="w-full bg-red-600 hover:bg-red-700 text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-100 flex items-center justify-center space-x-2"
                >
        ...
        return (
            <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-xl shadow-sm">
                <div className="flex items-start mb-3">
                    ...
                    <div className="flex-1">
                        <h3 className="font-semibold text-blue-800 text-sm">Routine Consultation</h3>
                        <p className="text-blue-700 text-sm mt-1">Schedule a video consultation for your pet</p>
                    </div>
                </div>
                <button
                    onClick={() => window.location.href = "/book-video-consultation"}
                    className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-100 flex items-center justify-center space-x-2"
                >
                    <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        return (
            <div className="mt-4 p-4 bg-gray-50 border border-gray-200 rounded-xl shadow-sm">
                <div className="flex items-start mb-3">
                    ...
                    <div className="flex-1">
                        <h3 className="font-semibold text-gray-800 text-sm">General Inquiry</h3>
                        <p className="text-gray-700 text-sm mt-1">Choose how you'd like to consult with a veterinarian</p>
                    </div>
                </div>
                <div className="space-y-3">
                    ...
                    <button
                        onClick={() => window.location.href = "/book-clinic-visit"}
                        className="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-[1.02] active:scale-100 flex items-center justify-center space-x-2"
                    >
                        <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                        </svg>
