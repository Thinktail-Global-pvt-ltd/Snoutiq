...
<aside class="w-64 bg-gradient-to-b from-indigo-700 to-purple-700 text-white flex flex-col">
  ...
  <nav class="px-3 py-4 space-y-1 text-sm grow">
    ...
    @else
      ...
      <a href="{{ route('clinic.payments') }}" class="group flex items-center gap-3 px-3 py-2 rounded-lg transition hover:bg-white/10">
      ...
      <a href="{{ route('clinic.booking.payments') }}" class="group flex items-center gap-3 px-3 py-2 rounded-lg transition hover:bg-white/10">
      ...
      <a href="{{ route('clinic.doctors') }}" class="group flex items-center gap-3 px-3 py-2 rounded-lg transition hover:bg-white/10">
