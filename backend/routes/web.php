...
Route::prefix('admin')->group(function () {
    ...
    Route::middleware([EnsureAdminAuthenticated::class])->group(function () {
        ...
        Route::get('/pet-feedback', [AdminPanelController::class, 'petFeedback'])->name('admin.pet-feedback');
        Route::get('/lead-management', function (Request $request) {
            ...
            try {
                ...
                dd([
                    'stage' => 'lead_management_route_controller_exception',
        ...
        Route::post('/lead-management/users/{user}/log', [AdminPanelController::class, 'storeLeadManagementLog'])
        ...
        Route::post('/lead-management/users/{user}/ai-marketing-push', [AdminPanelController::class, 'sendLeadManagementAiMarketingPush'])
    ...
    Route::get('/vet-registrations', [AdminPanelController::class, 'vetRegistrations'])->name('admin.vet-registrations');
        ...
        Route::get('/transactions/excell-export/{transaction}/invoice', [AdminPanelController::class, 'downloadExcellExportInvoice'])->name('admin.transactions.excell-export.invoice');
        Route::post('/transactions/excell-export/{transaction}/capture', [AdminPanelController::class, 'markExcellExportTransactionCaptured'])->name('admin.transactions.excell-export.capture');
