...
export default function DogNeuteringDelhi() {
  const title = "Dog Neutering Surgery Delhi NCR — Safe & Painless | SnoutiQ";
  const description =
        ...
        <section className="bg-gradient-to-br from-brand-light via-white to-white py-16 md:py-24 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
              Safe &amp; Painless Dog Neutering Surgery in Delhi NCR
            </h1>
            <p className="text-lg md:text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
              Expert surgical care for your dog. Includes pre-op blood test, surgery, and post-op
