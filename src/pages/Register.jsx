...
const RegisterBasicDetails = () => {
  ...
  const handleLocationRequest = () => {
    if (locationStatus === 'denied') {
      toast.error("Please enable location in your browser settings and refresh the page.");
      return;
    }
    requestLocation();
  };
 ...
 const userId = data.user_id;
  ...
  const handleNext = async () => {
    ...
    if (locationStatus === 'prompt' || locationStatus === 'checking') {
      ...
      toast.error("Location access is required to proceed. Please allow location access.");
    }
  };
