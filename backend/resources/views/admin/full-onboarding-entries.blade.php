                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="min-width: 320px;">
                                                                @forelse($doctorPackages as $package)
                                                                    <div class="small">Puppy vaccination package: {{ $fmtMoney($package->puppy_vaccination_package_price ?? $package->dog_vaccination_male_package_price ?? $package->dog_vaccination_package_price) }}</div>
                                                                    <div class="small">Adult dog package: {{ $fmtMoney($package->adult_dog_vaccination_package_price ?? $package->dog_vaccination_female_package_price ?? $package->dog_vaccination_package_price) }}</div>
                                                                    <div class="small">Kitten vaccine package: {{ $fmtMoney($package->kitten_vaccination_package_price ?? $package->cat_vaccination_male_package_price ?? $package->cat_vaccination_package_price) }}</div>
                                                                    <div class="small">Adult cat vaccination package: {{ $fmtMoney($package->adult_cat_vaccination_package_price ?? $package->cat_vaccination_female_package_price ?? $package->cat_vaccination_package_price) }}</div>
                                                                ...
                                                                <div class="collapse mt-2" id="packagesEdit{{ $doctor->id }}">
                                                                    <form method="POST" action="{{ route('admin.full-onboarding.doctors.packages.update', ['doctor' => $doctor->id, 'date_filter' => $dateFilter, 'from_date' => $fromDate]) }}" class="border rounded p-2 bg-white">
                                                                        ...
                                                                        @php
                                                                            $packageFields = [
                                                                                'puppy_vaccination_package_price' => ['Puppy vaccination package', '', $packageEdit->puppy_vaccination_package_price ?? $packageEdit->dog_vaccination_male_package_price ?? $packageEdit->dog_vaccination_package_price ?? null],
                                                                                'adult_dog_vaccination_package_price' => ['Adult dog package', '', $packageEdit->adult_dog_vaccination_package_price ?? $packageEdit->dog_vaccination_female_package_price ?? $packageEdit->dog_vaccination_package_price ?? null],
                                                                                'kitten_vaccination_package_price' => ['Kitten vaccine package', '', $packageEdit->kitten_vaccination_package_price ?? $packageEdit->cat_vaccination_male_package_price ?? $packageEdit->cat_vaccination_package_price ?? null],
                                                                                'adult_cat_vaccination_package_price' => ['Adult cat vaccination package', '', $packageEdit->adult_cat_vaccination_package_price ?? $packageEdit->cat_vaccination_female_package_price ?? $packageEdit->cat_vaccination_package_price ?? null],
