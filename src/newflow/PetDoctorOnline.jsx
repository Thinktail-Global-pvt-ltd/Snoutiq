...
const HERO_REVIEW_CARDS = [
  ...
  {
    name: "Ananya K.",
    text: "₹399 to consult a qualified pet doctor online is excellent value. My Labrador had a skin issue — the vet assessed it on video and explained exactly what to do next.",
  },
];
