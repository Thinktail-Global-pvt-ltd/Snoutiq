  ...
  return (
    <>
      <HelmetProvider>
        <Helmet>
          {/* SEO Meta Tags */}            <title>
              Vaccination Schedule for Pets in India 2025 | Complete Guide for
              Dogs & Cats
            </title>
            <meta
              name="title"
              content="Vaccination Schedule for Pets in India - Complete Guide 2025"
            />
            <meta
              name="description"
              content="Complete vaccination schedule for pets in India 2025. Learn about dog and cat vaccination timeline, costs, core vaccines, booster shots and expert pet care tips."
            />
            <meta
              name="keywords"
              content="vaccination schedule for pets in india, pet vaccination timeline india, dog vaccination schedule india, cat vaccination schedule india, pet vaccines cost india, rabies vaccine pets india"
            />
            ...
            <meta
              ...
              content="Comprehensive guide on pet vaccination in India with age-wise charts, costs, and expert recommendations for dogs and cats."
            />
            <meta property="og:type" content="article" />
            <meta
              property="og:url"
              content="https://snoutiq.com/vaccination-schedule-pets-india"
            />
            <meta
              property="og:image"
              content="https://snoutiq.com/images/pet-vaccination-guide.jpg"
            />
            <link
              rel="canonical"
            ...
            <script type="application/ld+json">
              {JSON.stringify({
                ...
                "@type": "Article",
                headline:
                  "Vaccination Schedule for Pets in India - Complete Guide 2025",
                description:
                  "Complete vaccination schedule for pets in India 2025. Learn about dog and cat vaccination timeline, costs, core vaccines, booster shots and expert pet care tips.",
        ...
        <div className="font-sans text-gray-800 bg-gradient-to-br from-indigo-50 to-purple-50 min-h-screen">
          <Header />
          <article
            className="max-w-4xl mx-auto bg-white shadow-xl shadow-indigo-100 rounded-xl overflow-hidden my-8 mt-20"
            itemScope
          ...
          >
            ...
            <header className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white relative overflow-hidden py-16 px-8 text-center">
              ...
              <div className="relative z-10">
                ...
                <p className="text-xl md:text-2xl opacity-95 font-light mb-8 leading-relaxed">
                  Complete Guide 2025 - Protect Your Dog & Cat with Timely
                  Vaccines
                </p>
            ...
            <div className="px-6 md:px-10 py-8" itemProp="articleBody">
              <p className="text-gray-700 text-lg mb-6 leading-relaxed">
                Vaccines play a crucial role in protecting your pets from
                dangerous diseases. Following the correct{" "}
                <strong className="font-bold text-indigo-600">
                  vaccination schedule for pets in India
                </strong>{" "}
                ensures your dog or cat lives a healthy and disease-free life.
              </p>

              <p className="text-gray-700 text-lg mb-8 leading-relaxed">
                This comprehensive guide covers the complete pet vaccination
                timeline in India, including core and optional vaccines,
                age-wise charts, booster shots, and costs. Whether you are a new
                pet parent or updating your pet's medical record, this guide
                makes vaccination simple and reliable.
              </p>

              {/* Table of Contents */}
              <nav
                className="bg-gradient-to-r from-indigo-50 to-purple-100 border-l-4 border-indigo-500 p-6 md:p-8 rounded-xl shadow-sm mb-12"
              ...
              <section id="why-vaccination" className="scroll-mt-20 mb-12">
                ...
                <p className="text-gray-700 text-lg mb-6 leading-relaxed">
                  Vaccines prepare your pet's immune system to detect and fight
                  harmful viruses and bacteria. Without timely vaccination, pets
                  are highly vulnerable to fatal infections such as rabies,
                  parvovirus, distemper, and feline panleukopenia.
                </p>
                  ...
                  {[
                    {
                      ...
                      desc: "Protection from severe and deadly diseases that can be fatal",
                    },
                    {
                      icon: "🚫",
                      title: "Transmission Prevention",
                      desc: "Reduces risk of transmission to other pets and humans",
                    },
                    {
                      icon: "💰",
                      title: "Cost Savings",
                      desc: "Saves long-term veterinary treatment costs",
                    },
                    {
                      icon: "✈️",
                      title: "Travel Ready",
                      desc: "Required for travel, grooming, and pet boarding facilities",
                    },
                    {
                      icon: "❤️",
                      title: "Responsible Parenting",
                      desc: "Ensures responsible and safe pet ownership",
                    },
                    {
                      icon: "📋",
                      title: "Legal Compliance",
                      desc: "Meets legal requirements for pet ownership",
                    },
                  ].map((benefit, index) => (
                    <div
                      key={index}
                      className="bg-white border-t-4 border-indigo-500 rounded-xl p-6 text-center shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                    >
                ...
                <p className="text-gray-700 text-lg leading-relaxed">
                  ...
                  is essential for your pet's long-term health and wellbeing.
                </p>
              </section>

              {/* Section 2: Dog Schedule */}
              <section
                id="vaccination-schedule-for-dogs-in-india"
              ...
              >
                ...
                <div className="bg-gradient-to-r from-blue-50 to-sky-50 border-l-4 border-blue-500 rounded-xl p-6 mb-6 shadow-sm">
                  <p className="text-gray-800 text-lg flex items-start gap-2">
                    💡 <strong className="text-blue-600">Tip:</strong> If your
                    pet has no vaccination history, consult a vet to restart the
                    cycle safely and create a proper immunization plan.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-r from-indigo-50 to-purple-50 border-l-4 border-indigo-500 rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-gray-700 mb-4">
                    DHPPi is a combination vaccine that protects against:
                  </p>
                  <ul className="list-disc pl-6 space-y-3">
                    <li className="text-gray-700">
                      <strong>D</strong> - Distemper (viral disease affecting
                      multiple organs)
                    </li>
                    <li className="text-gray-700">
                      <strong>H</strong> - Hepatitis (liver infection)
                    </li>
                    <li className="text-gray-700">
                      <strong>P</strong> - Parvovirus (severe gastrointestinal
                      disease)
                    </li>
                    <li className="text-gray-700">
                      <strong>P</strong> - Parainfluenza (respiratory infection)
                    </li>
                    <li className="text-gray-700">
                      <strong>i</strong> - Infectious diseases protection
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section
                id="vaccination-schedule-for-cats-in-india"
                className="scroll-mt-20 mb-12"
              >
                <h2 className="text-3xl md:text-4xl font-bold text-indigo-600 mb-8 pb-4 border-b-2 border-indigo-500 relative">
                  Vaccination Schedule for Cats in India
                ...
                <div className="bg-gradient-to-r from-yellow-50 to-amber-50 border-l-4 border-amber-500 rounded-xl p-6 mb-6 shadow-sm">
                  <p className="text-gray-800 text-lg font-semibold">
                    ⚠️ <span className="text-amber-600">Important:</span> Even
                    indoor cats need vaccinations because infections can enter
                    homes through shoes, hands, clothing, or visiting animals.
                    Never assume indoor cats are completely safe from diseases.
                  </p>
                </div>
                ...
                <div className="bg-gradient-to-r from-indigo-50 to-purple-50 border-l-4 border-indigo-500 rounded-xl p-6 shadow-sm">
                  ...
                  <p className="text-gray-700 mb-4">
                    FVRCP is a core combination vaccine for cats protecting
                    against:
                  </p>
                  <ul className="list-disc pl-6 space-y-3">
                    <li className="text-gray-700">
                      <strong>F</strong> - Feline Viral Rhinotracheitis
                      (respiratory infection)
                    </li>
                    <li className="text-gray-700">
                      <strong>V</strong> - Viral infections
                    </li>
                    <li className="text-gray-700">
                      <strong>R</strong> - Respiratory diseases
                    </li>
                    <li className="text-gray-700">
                      <strong>C</strong> - Calicivirus (respiratory and oral
                      disease)
                    </li>
                    <li className="text-gray-700">
                      <strong>P</strong> - Panleukopenia (feline distemper)
                    </li>
                  </ul>
                </div>
              </section>
              ...
              {/* Section 4: Cost */}
              <section
                id="cost-of-pet-vaccination-in-india"
                className="scroll-mt-20 mb-12"
              >
                <h2 className="text-3xl md:text-4xl font-bold text-indigo-600 mb-8 pb-4 border-b-2 border-indigo-500 relative">
                  Cost of Pet Vaccination in India
                ...
                <p className="text-gray-700 text-lg mb-6 leading-relaxed">
                  Vaccination costs vary based on city, clinic reputation, and
                  vaccine brand. Here's an approximate price guide:
                </p>
                ...
                <div className="bg-gradient-to-r from-blue-50 to-sky-50 border-l-4 border-blue-500 rounded-xl p-6 shadow-sm">
                  <p className="text-gray-800 text-lg">
                    💡 <strong className="text-blue-600">Note:</strong> Prices
                    vary based on city, clinic, and vaccine brand. Metro cities
              ...
              <section id="annual-booster-shots" className="scroll-mt-20 mb-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div className="bg-white border-l-4 border-indigo-500 rounded-xl p-6 shadow-sm">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      <li className="text-gray-700">
                        DHPPi and Rabies once every 12 months
                      </li>
                    </ul>
                  </div>
                  <div className="bg-white border-l-4 border-purple-500 rounded-xl p-6 shadow-sm">
                    ...
                    <ul className="list-disc pl-6 space-y-2">
                      ...
                      <li className="text-gray-700">
                        FeLV as required based on exposure
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <p className="text-gray-700 text-lg">
                  Annual boosters help maintain strong immunity and are
                  essential for long-term protection against diseases.
                </p>
              </section>

              {/* Section 6: Missed Vaccine */}
              <section
                id="what-to-do-if-you-miss-a-vaccine"
                className="scroll-mt-20 mb-12"
              >
                <h2 className="text-3xl md:text-4xl font-bold text-indigo-600 mb-8 pb-4 border-b-2 border-indigo-500 relative">
                  What to Do If You Miss a Vaccine
                ...
                <p className="text-gray-700 text-lg mb-6 leading-relaxed">
                  Missing a vaccine is common and can be managed with proper
                  veterinary guidance.
                </p>

                <ul className="list-disc pl-6 space-y-3 mb-6">
                  <li className="text-gray-700">
                    Visit a vet immediately for assessment
                  </li>
                  <li className="text-gray-700">
                    Restart the schedule if needed based on gap duration
                  </li>
                  <li className="text-gray-700">
                    Avoid giving vaccines at home without supervision
                  </li>
                  <li className="text-gray-700">
                    Older pets may need antibody titer tests to check immunity
                    levels
                  </li>
                </ul>
                ...
                <div className="bg-gradient-to-r from-yellow-50 to-amber-50 border-l-4 border-amber-500 rounded-xl p-6 shadow-sm">
                  <p className="text-gray-800 text-lg font-semibold">
                    ⚠️ <span className="text-amber-600">Important:</span> Timely
                    management is crucial to maintain immunity. Extended gaps
                    may require restarting the entire vaccination series.
                  </p>
                </div>
              </section>
              ...
              >
                  ...
                  <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="bg-white divide-y divide-gray-200">
                      ...
                      <tr className="bg-white hover:bg-indigo-100">
                        ...
                        <td className="px-6 py-4 text-gray-700">
                          Based on lifestyle and risk
                        </td>
                        <td className="px-6 py-4 text-gray-700">
                          FeLV, Leptospirosis, Kennel Cough
                        </td>
                      </tr>
                    </tbody>
                  </table>
                ...
                <p className="text-gray-700 text-lg">
                  Your vet will recommend non-core vaccines based on exposure,
                  environment, and your pet's daily routine. Factors like
                  outdoor access, interaction with other animals, and geographic
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-emerald-500 rounded-xl p-6 shadow-sm">
                    ...
                    <ul className="list-disc pl-6 space-y-3">
                      ...
                      <li className="text-gray-700">
                        Keep the pet well hydrated
                      </li>
                      <li className="text-gray-700">
                        Monitor for mild reactions like slight fever
                      </li>
                      <li className="text-gray-700">
                  ...
                  <div className="bg-gradient-to-r from-red-50 to-pink-50 border-l-4 border-red-500 rounded-xl p-6 shadow-sm">
                    ...
                    <ul className="list-disc pl-6 space-y-3">
                      <li className="text-gray-700">
                        No bathing for 48 hours after vaccination
                      </li>
                      <li className="text-gray-700">
                        No heavy exercise or strenuous activity
                      </li>
                      <li className="text-gray-700">
                        Do not repeat the dose yourself
                      </li>
                      <li className="text-gray-700">
                        Avoid exposing to other sick animals
                      </li>
                      <li className="text-gray-700">
                ...
                <div className="bg-gradient-to-r from-yellow-50 to-amber-50 border-l-4 border-amber-500 rounded-xl p-6 shadow-sm">
                  <p className="text-gray-800 text-lg font-semibold">
                    ⚠️ <span className="text-amber-600">Emergency Signs:</span>{" "}
                    If your pet shows severe swelling, vomiting, difficulty
                    breathing, or continuous high fever, visit a vet
                    immediately. These could indicate serious allergic
                    reactions.
                  </p>
                </div>
              </section>
              ...
              <section
                id="quick-reference-vaccination-chart"
                className="scroll-mt-20 mb-12"
              >
                <h2 className="text-3xl md:text-4xl font-bold text-indigo-600 mb-8 pb-4 border-b-2 border-indigo-500 relative">
                  Quick Reference Vaccination Chart
                ...
                <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-emerald-500 rounded-xl p-6 shadow-sm">
                  <p className="text-gray-800 text-lg flex items-start gap-2">
                    ...
                    Keeping a printed or digital vaccination record helps avoid
                    missed doses and is required for boarding, travel, and
                    emergencies.
                  </p>
                </div>
              </section>
              ...
              <div className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-xl p-8 md:p-10 text-center shadow-2xl mb-12">
                <h3 className="text-2xl md:text-3xl font-bold mb-6">
                  🏠 Visit Snoutiq for More Pet Care Tips
                </h3>
                <p className="text-xl opacity-95 mb-8">
                  Explore comprehensive guides on pet nutrition, training,
                  grooming, and emergency care.
                </p>
                <div className="flex flex-wrap justify-center gap-4">
                  <a
                    href="https://snoutiq.com/"
                    className="bg-white text-indigo-600 font-bold py-3 px-6 rounded-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                  >
                    Visit Homepage
                  </a>
                  <a
                    href="https://snoutiq.com/first-aid-tips-pet-parents"
                    className="bg-purple-500 text-white font-bold py-3 px-6 rounded-full hover:shadow-xl hover:-translate-y-1 transition-all duration-300"
                  >
              ...
              <section
                id="faq"
                className="scroll-mt-20 bg-gradient-to-r from-indigo-50 to-purple-50 px-6 md:px-10 py-12 rounded-xl"
              >
                <div className="max-w-4xl mx-auto">
                  ...
                  <div className="space-y-6">
                    {[
                      ...
                      <div
                        key={index}
                        className="bg-white border-l-4 border-indigo-500 rounded-xl p-6 shadow-lg hover:shadow-xl hover:translate-x-2 transition-all duration-300"
                        itemScope
            ...
            <footer className="bg-gradient-to-r from-gray-800 to-gray-900 text-white px-6 md:px-10 py-12">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-lg mb-6 text-gray-200">
                  ...
                  is the most effective way to protect your pet from dangerous
                  diseases. With timely vaccines, annual boosters, a healthy
                  diet, and regular vet visits, your pet can enjoy a long and
                  healthy life.
                </p>
                <p className="text-lg mb-6 text-gray-200">
                  For more trusted pet care information, visit{" "}
                  <a
                    href="https://snoutiq.com/"
                  ...
                  guide to stay prepared for emergencies.
                </p>
