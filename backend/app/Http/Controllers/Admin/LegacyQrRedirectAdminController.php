...
class LegacyQrRedirectAdminController extends Controller
{
    public function index()
    {
        ...
        return view('backend.clinics.legacy-qr', compact('redirects', 'clinics'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.legacy-qr.index')->with('status', $status);
    }

    public function destroy(LegacyQrRedirect $legacyQrRedirect)
    {
        ...
        return redirect()->route('admin.legacy-qr.index')->with('status', 'Mapping removed.');
    }
}
