            ...
            <div class="card-body p-4">
                <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-3 excel-export-summary">
                    <div>
                        ...
                        <p class="text-muted mb-0">All rows from <code>transactions</code> where <code>type = excell_export_campaign</code>. Invoice is allowed only when payment status is <code>captured</code>.</p>
                    </div>
                                        ...
                                        <td data-label="Invoice">
                                            ...
                                            @else
                                                ...
                                                @if(!$invoiceStatusEligible)
                                                    <div class="text-muted small mt-1">Payment is not captured. Mark captured first to enable invoice.</div>
                                                @else
