...
use App\Http\Controllers\Api\UserButtonClickController;
...
use App\Http\Controllers\Api\VetAppVersionController;
...
Route::get('/app-version/pet-parent', [AppVersionController::class, 'petParent']);
Route::get('/app-version/vet-app', [VetAppVersionController::class, 'show']);
Route::middleware(['web', EnsureAdminAuthenticated::class])->group(function () {
    ...
    Route::get('/admin/vet-app-versions', [VetAppVersionController::class, 'adminList']);
});
Route::put('/admin/app-versions/{id}', [AppVersionController::class, 'update'])->whereNumber('id');
Route::put('/admin/vet-app-versions/{id}', [VetAppVersionController::class, 'update'])->whereNumber('id');
...
Route::post('/button-clicks/analyze', [UserButtonClickController::class, 'analyze'])->name('api.button-clicks.analyze');
...
Route::post('/google-merge-user', [AuthController::class, 'googleMergeUser']);
...
Route::post('/pets/{petId}/daily-care', [\App\Http\Controllers\Api\PetDailyCareController::class, 'store']);
...
Route::post('/medical-records/parse-vaccination-certificate', [GeminiChatController::class, 'parseVaccinationCertificate']);
