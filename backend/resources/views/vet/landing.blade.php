...
<head>
  @php
    ...
    $baseAppDownloadUrl = 'https://play.google.com/store/apps/details?id=com.petai.snoutiq';
    $appDownloadUrl = $baseAppDownloadUrl;
    if (!empty($vet->id)) {
        $referrerRaw = 'clinic_id=' . $vet->id . '&src=qr';
        $appDownloadUrl = $baseAppDownloadUrl . '&referrer=' . urlencode($referrerRaw);
    }
