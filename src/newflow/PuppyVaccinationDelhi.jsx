...
export default function PuppyVaccinationDelhi() {
  const title = "Puppy Vaccination Package Delhi NCR — Starting ₹2,499 | SnoutiQ";
  const description =
        ...
        <section className="bg-gradient-to-br from-brand-light via-white to-white py-16 md:py-24 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 leading-tight">
              Complete Puppy Vaccination Package in Delhi NCR
            </h1>
            <p className="text-lg md:text-xl text-slate-600 mb-8 max-w-2xl mx-auto">
              All vaccines. All visits. One package. Administered by experienced vets
              at trusted clinics across Delhi, Gurugram, Noida, and Faridabad.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
              ...
              <Link to="/lp/puppy-vaccination" className="w-full sm:w-auto">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg prose-slate max-w-none">
              <p>
                ...
                experience. Our packages are designed to cover everything your pet needs, with
