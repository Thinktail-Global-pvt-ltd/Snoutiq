...
//           className="w-full pl-10 sm:pl-12 pr-14 sm:pr-16 py-3 sm:py-4 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#2761E8] focus:border-transparent text-gray-800 placeholder-gray-400 text-sm sm:text-base"
//         />
...
//           type="submit"
//           disabled={isLoading}
//           className="absolute right-2 w-8 h-8 sm:w-10 sm:h-10 bg-[#2761E8] text-white rounded-full flex items-center justify-center hover:bg-[#1e4bd8] transition-colors disabled:opacity-70"
//         >
//           {isLoading ? (
//             <svg
